...
tab_overview, tab_horloges, tab_spectral, tab_forecast, tab_DCA, tab_histoire, tab_divers= st.tabs(
    [
        "📈 Vue d'ensemble",
        "⏱️ Horloges et cycle",
        "💹 Analyse spectrale",
...
with tab_overview:
  st.header("Vue d'ensemble et Données Globales")
  ...
  ENERGY_PARAMS = {
      "energy_decay_10": 2.86,
      "energy_scale_macro": 1.72,
      "energy_scale_micro": 0.62,
  }
